"""
DropBox Files duplicate detector ::

Checks if the there are duplicate files in the dropbox
...
author(s) : Subhadeep Maji, Samujjwal Ghosh
"""
...
def connect_user(drpbx_id):
    ...
    db_flow = dropbox.client.DropboxOAuth2FlowNoRedirect(app_key, \
                                                             app_secret)
...
def parse_options():
    ...
    " file name: 'possible_duplicates.txt'")
